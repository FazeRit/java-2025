...
@Data
@Schema(description = "DTO для оновлення даних про втрачену річ")
public class LostItemUpdateDto {
    ...
    @Schema(description = "Теги для швидкого пошуку (макс 10)", example = "[\"wallet\", \"black\", \"leather\"]")
    ...
    @Schema(description = "Контактний номер телефону у міжнародному форматі", example = "+380931234567")
